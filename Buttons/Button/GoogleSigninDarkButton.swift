...
class GoogleSigninDarkButton: UIButton {
  enum Constant {
    static let bgImageForNormal = makeResizable(UIImage(named: "btn_google_signin_dark_normal_ios"))
    static let bgImageForPressed = makeResizable(UIImage(named: "btn_google_signin_dark_pressed_ios"))
    static let bgImageForFocus = makeResizable(UIImage(named: "btn_google_signin_dark_focus_ios"))
    static let bgImageForDisabled = makeResizable(UIImage(named: "btn_google_signin_dark_disabled_ios"))
